...
/** Provides a static method search for searching an array using Linear Search. */
public class ArraySearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Occurance of 7 is in the index " + search(x,7));
        System.out.println("Occurance of 17 is in the index " + search(x,17));
