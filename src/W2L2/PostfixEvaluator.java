...
public class PostfixEvaluator {
    ...
    public int eval(String expression) throws SyntaxErrorException {
        ...
        try {
            String nextToken;
            // nextToken read from expression should be digit, space or operators +,-,*,/
    ...
    public static void main(String args[]) throws SyntaxErrorException{
    	...
    	int res = pe.eval("4 7 2 + *");
    	System.out.println(" 4 7 2 + * :" + res);
    	int res1 = pe.eval("3 4 7 * 2 / + ");
    	System.out.println(" 4 7 2 + *  : " + res1);
