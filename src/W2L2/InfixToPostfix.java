...
public class InfixToPostfix {
    ...
    private static final int[] PRECEDENCE = {1, 1, 2, 2}; // Values for { +, -, *, / }
    /**
     * The Pattern to extract tokens
     * A token is either a string of digits (\d+)
     * or a JavaIdentifier
     * or an operator
     * (.) indicates -> Matches any single character except newline. 
     * (+) -> Matches one or more occurrences of a regular expression
     * (*) -> Matches Zero or more occurrences
     * \\p{javaJavaIdentifierStart} means a character acceptable 
     *  to be the first character of any valid java identifier.
     *  
     *  \\p{javaJavaIdentifierPart}* - determines if the character 
    ...
    public String convert(String infix) throws SyntaxErrorException {
        ...
        try {
            ...
            /* findInLine() - >Attempts to find the next occurrence of the 
             specified pattern ignoring delimiters.
